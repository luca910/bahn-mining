...
(
    ...
    `id`   VARCHAR(50) UNIQUE NOT NULL COMMENT 'Message id.',
    `int`  TEXT DEFAULT NULL COMMENT 'Internal text.',
    ...
    `ts`   TEXT               NOT NULL COMMENT 'Timestamp. The time, in ten digit &#39;YYMMddHHmm&#39; format, e.g. \&quot;1404011437\&quot; for 14:37 on April the 1st of 2014.',
    PRIMARY KEY (id(50))
